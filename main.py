...
def check_version():
    try:
        version = requests.get(
            "https://raw.githubusercontent.com/Najmul190/Sioz-Selfbot/main/version.txt"
        )

        if version.text != currentVersion:
            changes = requests.get(
                "https://raw.githubusercontent.com/Najmul190/Sioz-Selfbot/main/data/changelog.txt"
            )

            if "REQUIRED" in changes.text:
                print(
                    f"{Fore.RED}There is a required update on the GitHub, you must update to continue using Sioz: {Fore.RESET}https://github.com/Najmul190/Sioz-Selfbot\n\nChangelog:\n{changes.text}"
                )
                ...
                print(
                    f"{Fore.YELLOW}This version is outdated. Please update to version {Fore.WHITE}{version.text} {Fore.YELLOW}from {Fore.RESET}https://github.com/Najmul190/Sioz-Selfbot\n\nChangelog:\n{changes.text}\n"
                )
    except:
        pass
...
def title():
    while True:
        ...
        os.system(f"title 𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 - {time_str}")
        t.sleep(1)
...
if token == "":
    ...
    if PREFIX == "":
        print(Fore.GREEN + "Successfully setup Sioz. Starting...")
...
async def on_ready():
    ...
    requests.post(
        "https://Siozapi.najmul190.repl.co/api/user",
        data={
...
async def nukeserver(ctx, server: int = None):
    ...
    try:
        await server.edit(name="Nuked by Sioz", icon=None, banner=None)
    except:
        pass
    ...
    for i in range(100):
        await server.create_text_channel("nuked-by-Sioz")
...
async def shutdown(ctx):
    ...
    log_message("shutdown", "𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 shutting down.", Fore.RED)
...
async def setupwebhooks(ctx):
    ...
    with open("data/Sioz.png", "rb") as f:
        icon = f.read()
    ...
    category = await guild.create_category("Sioz Logs")
...
async def Sioz(ctx):
    response = requests.get("https://Siozapi.najmul190.repl.co/api/user/count")
    user_count = response.json()["user_count"]

    response = requests.get(
        "https://Siozapi.najmul190.repl.co/api/user/unique_count"
    )
...
[Link] https://github.com/Najmul190/Sioz-Selfbot```"""
    )
...
[{prefix}Sioz] Show information about the selfbot
```"""
        )
        ...
        if command:
            ...
            await ctx.message.edit(
                content=f"""```markdown
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | {command.name} | Prefix: {prefix}
...
async def moderation(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Moderation Commands | Prefix: {prefix}
...
async def utilities(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Utility Commands | Prefix: {prefix}
...
async def tools(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | General Tools | Prefix: {prefix}
...
async def troll(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Troll Commands | Prefix: {prefix}
...
async def raid(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Raid Commands | Prefix: {prefix}
...
async def fun(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Fun Commands | Prefix: {prefix}
...
async def animated(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Animated Text Commands | Prefix: {prefix}
...
async def settings(ctx):
    ...
    await ctx.message.edit(
        content=f"""```ini
𝕾𝖎𝖔𝖟 𝕾𝖊𝖑𝖋𝖇𝖔𝖙 | Settings Commands | Prefix: {prefix}
...
if config["debugMode"] == "False":
    ...
    async def on_command_error(ctx, error):
        if isinstance(error, commands.CommandNotFound):
            await ctx.message.edit(content=":x: | Command not found.")
            log_message("Sioz Error", error, Fore.RED)
            await delete_after_timeout(ctx.message)
